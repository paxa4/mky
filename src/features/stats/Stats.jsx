  ...
  return (
    <section style={{ marginTop: 52 }}>
      <style>{`
        ...
        .stat-box:hover { box-shadow: 0 6px 20px rgba(25,120,156,0.1); transform: translateY(-2px); }
      `}</style>
      ...
      <div className="stats-row">
        {STATS.map(s => (
          <div key={s.label} className="stat-box">
            ...
            <div style={{ fontSize: 26, fontWeight: 800, color: "#19789C", letterSpacing: "-0.03em", lineHeight: 1 }}>{s.value}</div>
