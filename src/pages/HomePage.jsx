...
export default function HomePage({ onGoAuth, onGoProfile, onGoAdmin, publishedArticles, currentUser }) {
  useEffect(() => {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ maxWidth: 1200, margin: "0 auto", padding: "36px 24px 56px", width: "100%", flex: 1 }}>
        {/* Передаём опубликованные статьи в ленту */}
        <NewsFeed articles={publishedArticles} />
        <Stats />
        <QuickAccess />
      </main>
      <Footer />
